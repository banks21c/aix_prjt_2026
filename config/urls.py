...
from articles.views import (
    ...
    json_formatter_view, korean_amount_view, world_clock_view,
    password_generator_view, file_hash_view, text_encrypt_view, base64_encoder_view, uuid_generator_view, image_resizer_view, image_converter_view, image_compressor_view, image_mosaic_view, screen_recorder_view, pdf_tools_view, qrcode_generator_view, background_remover_view,
...
urlpatterns = [
    ...
    path('admin-tools/works/<int:pk>/', work_detail_view, name='work_detail'),
    ...
    path('tools/reading-time/', reading_time_view, name='reading_time'),
    ...
    path('tools/password-generator/', password_generator_view, name='password_generator'),
    path('tools/file-hash/', file_hash_view, name='file_hash'),
    path('tools/text-encrypt/', text_encrypt_view, name='text_encrypt'),
    path('tools/base64-encoder/', base64_encoder_view, name='base64_encoder'),
    path('tools/uuid-generator/', uuid_generator_view, name='uuid_generator'),
